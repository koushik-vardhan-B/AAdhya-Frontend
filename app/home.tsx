        ...
        >
            <ScrollView contentContainerStyle={styles.scrollContent}>
                ...
                <View style={styles.header}>
                    <Text style={styles.title}>🛡️ Digital Safety Guard</Text>
                    <Text style={styles.subtitle}>Protecting rural citizens from online fraud</Text>
                </View>

                {/* Message Input */}
                <View style={styles.sectionHeader}>
                    <Text style={styles.sectionTitle}>Did you receive a suspicious message?</Text>
                    <Text style={styles.sectionDesc}>Paste the SMS, WhatsApp message, or link below to check if it's safe or a scam.</Text>
                </View>
