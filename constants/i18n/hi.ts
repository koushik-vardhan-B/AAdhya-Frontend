...
export const hi: Translations = {
    ...
    quickActions: {
        title: 'अन्वेषण करें',
        scanImage: 'स्क्रीनशॉट स्कैन',
        scanImageDesc: 'छवि अपलोड या कैप्चर करें',
        dashboard: 'डैशबोर्ड',
        dashboardDesc: 'आंकड़े और अंतर्दृष्टि',
        history: 'इतिहास',
        historyDesc: 'पिछले स्कैन परिणाम',
        community: 'समुदाय',
        communityDesc: 'रिपोर्ट की गई धोखाधड़ी',
    },

    scanImage: {
        title: 'स्क्रीनशॉट स्कैन करें',
        subtitle: 'संदिग्ध SMS या संदेश का स्क्रीनशॉट अपलोड करें',
        pickImage: 'गैलरी से चुनें',
        takePhoto: 'फोटो लें',
        analyzeBtn: 'स्क्रीनशॉट का विश्लेषण करें',
        analyzing: 'टेक्स्ट निकालना और विश्लेषण करना...',
        noText: 'छवि से कोई टेक्स्ट नहीं निकाला जा सका।',
    ...
    dashboard: {
        ...
        topPatterns: 'शीर्ष धोखाधड़ी पैटर्न',
        topKeywords: 'चिह्नित कीवर्ड',
        systemStatus: 'सिस्टम स्थिति',
        operational: 'चालू',
        noData: 'अभी तक कोई डेटा नहीं। पहले कुछ संदेशों का विश्लेषण करें!',
        refresh: 'रिफ्रेश',
    },

    history: {
        title: 'स्कैन इतिहास',
        noScans: 'अभी तक कोई स्कैन नहीं। एक संदेश का विश्लेषण करके शुरू करें!',
        viewDetail: 'विवरण देखें',
        scannedAt: 'स्कैन किया गया',
        fullMessage: 'पूरा संदेश',
        keywords: 'कीवर्ड',
    ...
    community: {
        ...
        subtitle: 'समुदाय से हाल की धोखाधड़ी रिपोर्ट',
